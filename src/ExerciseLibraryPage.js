...
// --- 메인 운동 라이브러리 페이지 컴포넌트 ---
function ExerciseLibraryPage({ isLoggedIn, onShowLogin, addToast, videos, onAddVideo, user }) { // ✅ user prop 받음
  ...
  return (
    <main className="exerciseLibrary-page-container container">
      <div className="page-header">
        <h2>운동 라이브러리</h2>
        <p>다른 사람들의 운동을 보고 피드백을 남겨주세요!</p>
      </div>
